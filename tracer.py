...
def tracer_tendency_upstream(GR, TRACER, HGHT, UWIND, VWIND, UFLX, VFLX, WIND):
    ...
    UFLX[GR.iisjj] = \
            GR.dy * (np.maximum(UWIND[GR.iisjj],0) * TRACER[GR.iisjj_im1] * HGHT[GR.iisjj_im1] + \
                        np.minimum(UWIND[GR.iisjj],0) * TRACER[GR.iisjj] * HGHT[GR.iisjj])
    ...
    VFLX[GR.iijjs] = \
            GR.dxjs[GR.iijjs] * ( np.maximum(VWIND[GR.iijjs],0) * TRACER[GR.iijjs_jm1] * HGHT[GR.iijjs_jm1] + \
                                    np.minimum(VWIND[GR.iijjs],0) * TRACER[GR.iijjs] * HGHT[GR.iijjs] )
